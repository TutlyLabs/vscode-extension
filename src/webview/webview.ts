...
export abstract class TutlyWebview implements Disposable {

    protected readonly viewType: string = "tutly.webview";
    ...
    protected abstract getWebviewOption(): ITutlyWebviewOption;

    protected abstract getWebviewContent(): string;
}

export interface ITutlyWebviewOption {
    title: string;
